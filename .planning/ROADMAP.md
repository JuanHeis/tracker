...
- [x] 23-02-PLAN.md — Fold cashEffect en `computeMonthMetrics.disponible` (Resultado conserva D2) + wiring de datos en expense-tracker.tsx + refactor de motores a la función compartida, cero regresión (AC-1, AC-2, AC-4, AC-5)
- [x] 23-03-PLAN.md — Test de reconciliación con fixture del backup real (ambos motores concuerdan, ARS+USD, ancla junio $28.168,76) + core `computeLiquidFlowForMonth` + script `test` (AC-1, AC-2, AC-3, AC-4, AC-6)
